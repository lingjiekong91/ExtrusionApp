                                    ...
                                    fluidRow(
                                      column(2,
                                             selectInput("PN","Part Number",
                                                         c("All",unique(as.character(data1$`Part Number`))))
                                      ),
                                      column(3,
                                             selectInput("PD","Part Description",
                                                         c("All",unique(as.character(data1$`Part Description`))))
                                      ),
                                      column(2,
                                             selectInput("RN","Resin Number",
                                                         c("All",unique(as.character(data1$`Resin Number`))))
                                      ),
                                      column(2,
                                             selectInput("RD","Resin Description",
                                                         c("All",unique(as.character(data1$`Resin Description`))))
                                      ),
                                      column(2,
                                             selectInput("PPSN","PPS Number",
                                                         c("All",unique(as.character(data1$`PPS Number`))))
                                      )
                                    ),
                                    fluidRow(
